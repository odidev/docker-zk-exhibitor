...
ENV \
    ZK_RELEASE="https://downloads.apache.org/zookeeper/zookeeper-3.5.9/apache-zookeeper-3.5.9.tar.gz" \
    ...
    BUILD_DEPS="curl maven default-jdk" \
...
RUN \
    ...
    && grep '^networkaddress.cache.ttl=' /etc/java-11-openjdk/security/java.security || echo 'networkaddress.cache.ttl=60' >> /etc/java-11-openjdk/security/java.security \
